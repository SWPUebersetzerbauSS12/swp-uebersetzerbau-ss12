 ...
 *
 */
public class CopyOfSyntaxTree implements Iterable<BinaryTreeNode> {
	...
	public CopyOfSyntaxTree( String regex)
			throws SyntaxTreeException {
		this( regex, null);
	}
	
	public CopyOfSyntaxTree( String regex, NewNodeEventHandler newNodeEventHandler)
			throws SyntaxTreeException {
		super();
