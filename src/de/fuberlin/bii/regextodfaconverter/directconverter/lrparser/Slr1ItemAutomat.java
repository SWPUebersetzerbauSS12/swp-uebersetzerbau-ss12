 ...
 * dann liefert die Eigenschaftsabfrage mit {@link ItemAutomata#isReduceConflictFree()} den Wert true.   
 * 
 * @author Johannes Dahlke
 *
 * @param <Element> der Typ eines Elementes der zu verarbeitenden Eingabe.
 */
public class Slr1ItemAutomat<Element extends Symbol> extends Lr0ItemAutomat<Element> {
